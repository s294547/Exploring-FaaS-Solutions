...
## Introduction
This repository, up to now, contains a directory for each FaaS solution I've tried to deploy.
Each directory contains:
1. A README.md file, which explains:
  1. How to deploy the spefic solution on a Kubernetes Cluster, using Docker Desktop on Windows 11 with Ubuntu 22 WSL 2. 
  2. How to create and trigger a "function" using the specific solution.
2. Some code snippets or files that may be useful during the installation process
